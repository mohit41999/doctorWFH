...
import 'package:doctor/Screens/video_player.dart';
...
class TextPage extends StatefulWidget {
  ...
  const TextPage({Key? key, required this.patientid, required this.patientName})
      : super(key: key);
...
class _TextPageState extends State<TextPage> {
  Future<void> sendmessage(BuildContext context, String message) async {
    ...
    if (message.isEmpty) {
      ...
      await PostData(PARAM_URL: 'add_doctor_chat.php', params: {
        'token': Token,
